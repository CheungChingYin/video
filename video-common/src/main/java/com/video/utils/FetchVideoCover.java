...
public class FetchVideoCover {
	...
	public void getCover(String videoInputPath, String coverOutputPath) throws IOException, InterruptedException {
		// ffmpeg.exe -ss 00:00:01 -i c.mp4 -vframes 1 new.jpg
	...
	public static void main(String[] args) {
		// 获取视频信息。
		FetchVideoCover videoInfo = new FetchVideoCover("F:\\soft\\ffmpeg\\bin\\ffmpeg.exe");
		try {
			videoInfo.getCover("F:\\soft\\ffmpeg\\bin\\c.mp4", "F:\\soft\\ffmpeg\\bin\\new.jpg");
